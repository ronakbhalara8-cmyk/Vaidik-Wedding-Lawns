...
const venues = [
  ...
  },
  {
    ...
    subtitle: "Wedding Lawn Near Sayan",
    capacity: "Up to 1500 - 2000 guests",
    bestFor: "Weddings",
    features: "Our venue can accommodate large gatherings and can be customized according to the requirements and style of your event.",
    style: "Your wedding deserves a venue that combines space, elegance and convenience.",
  ...
  },
  {
    ...
    subtitle: "Spacious Venue for Large Gatherings",
    capacity: "Up to 1500 - 2000 guests",
    bestFor: "Wedding receptions",
    features: "From the entrance and stage to seating, lighting and decorations, every part of your celebration can be planned to match your vision.",
    style: "Make Your Wedding Beautiful and Memorable",
