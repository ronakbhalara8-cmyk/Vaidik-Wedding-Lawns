      ...
      <section className="container py-20 md:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col gap-8 justify-center">
            <div>
              <span className="font-serif-heading text-xs font-bold tracking-[0.25em] text-maroon-base bg-maroon-light/10 border border-maroon-base/15 rounded-full px-4 py-1.5 inline-block mb-4">
                Connect Directly
              </span>
            ...
            <ul className="flex flex-col gap-6 text-sm text-charcoal/80 font-light">
              ...
              <li className="flex gap-4 items-start">
                ...
                <div>
                  <strong className="font-serif-heading text-xs font-bold tracking-wider uppercase text-maroon-base block mb-1">Call Booking Office</strong>
              ...
              <li className="flex gap-4 items-start">
                ...
                <div>
                  <strong className="font-serif-heading text-xs font-bold tracking-wider uppercase text-maroon-base block mb-1">Email Inquiries</strong>
              ...
              <li className="flex gap-4 items-start">
                ...
                <div>
                  <strong className="font-serif-heading text-xs font-bold tracking-wider uppercase text-maroon-base block mb-1">Office Hours</strong>
