...
export const metadata = {
  ...
  twitter: {
    ...
    title: "Vaidik Wedding Lawns | Where Dream Weddings Come True",
    description: "Celebrate your royal wedding at Vaidik Wedding Lawns. Discover our premium outdoor venue, elegant banquet space, customizable mandap setups, and luxury event coordination services.",
    images: [`${BASE_URL}/images/image-4.png`],
    site: "@vaidikwedding",
  ...
  return (
    ...
    >
      <head>
        ...
        <meta property="og:image" content={`${BASE_URL}/images/image-4.png`} />
        <meta property="og:image:secure_url" content={`${BASE_URL}/images/image-4.png`} />
        ...
        <meta name="twitter:image" content={`${BASE_URL}/images/image-4.png`} />
